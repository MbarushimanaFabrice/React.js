  ...
  return (
    <>
      ...
      <div className="ditailes putdown">
        ...
        <p>i am interested in technology and also i try to wark hard inorder  to taka <br />all opporunity i gaine in my learning jurney, also focus on self  study<br /> and i try to solve same society problems by use technology</p>
         
          <p><info>Name</info><datas> :Mbarushimana Fabrice</datas></p>
           <p><info>Age</info><datas> :19</datas></p>
